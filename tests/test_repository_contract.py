...
class RepositoryStructureTests(unittest.TestCase):
    ...
    def test_kernel_implementation_roadmap_matches_manifest(self) -> None:
        ...
        self.assertIn("Production auditors live: 9.", roadmap)
        self.assertIn("Specified auditors awaiting implementation: 9.", roadmap)
    ...
    def test_kernel_roadmap_prioritizes_next_build_wave(self) -> None:
        ...
        self.assertIn(
            "| 06 | TLAB | layer_1_telemetry | IMPLEMENTED | Live |",
            roadmap,
        )
        self.assertIn(
            "| 08 | FOAS | layer_3_compliance | IMPLEMENTED | Live |",
            roadmap,
        )
        self.assertIn(
