...
KERNEL_SPECIFICATIONS: Final[tuple[KernelSpecification, ...]] = (
    ...
    KernelSpecification(
        ...
        (
            "Discount each dated contractual cash flow using ACT/365F and the declared compounding frequency.",
            "Calculate dirty price, optional clean price, Macaulay duration, modified duration, and dirty-price DV01.",
            "Require exact convention agreement and a controlled rate-risk direction conclusion.",
        ),
        "Price, duration, and DV01 use independently declared non-negative relative tolerances and default to 0.5%.",
        (
        ...
        "FITV v1 supports ACT/365F and frequencies 1, 2, 4, or 12. Curve construction, embedded-option models, and live RFQ ingestion remain upstream.",
