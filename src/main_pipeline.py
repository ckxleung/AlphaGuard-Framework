...
'''
    ...
    ai_output = {
        ...
        "ai_summary": "test",
        "claimed_risk_deltas": [{"topic": "test"}],
        "skipped_calculation_step": False,
        "unsupported_regulatory_assertion": False,
        "material_financial_reconciliation_failure": False,
        "region_clipped_or_unreadable": False,
        "undeclared_assumptions": False,
        "non_negotiable_constraint_violated": False,
        "incompatible_commitments_as_consensus": False,
        "material_conflict_lacks_resolution": False,
        "material_recommendation_lacks_evidence": False,
        "missing_unit_economics_or_capacity": False,
        "promotional_language_substitutes_action": False,
        "future_information_in_feature": False,
        "random_kfold_on_time_dependent_rows": False,
        "accuracy_sole_metric_for_imbalanced": False,
        "mandatory_risk_lacks_control": False,
        "operating_effectiveness_from_design_only": False,
        "regulatory_requirement_lacks_provenance": False,
    }
    ground_truth = {
        ...
        "prior_period_filing_text": "a",
        "current_period_filing_text": "b",
        "section_boundaries": ["a"],
        "source_ids": ["a"],
        "period_end_dates": ["1", "2"],
        "actual_material_deltas": [{"topic": "test"}],
        "dated_operating_metrics": {"a": 1},
        "option_chain_snapshot": {"a": 1},
